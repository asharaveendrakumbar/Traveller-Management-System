...
<!-- HEAD TAG STARTS -->
<head>
<title>Mr.Traveller|Payment</title>
...
<link rel="stylesheet" href="css/jquery-ui.css" />
    ...
    <?php include('includes/header.php');?>
           <div class="slider-3">
	        <div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> Mr.Traveller-Payment</h1>
	</div>
</div>
  <!--- /slider ---->
