...
<html>
<head>
<title>Mr.Traveller|Boking</title>
...
<link rel="stylesheet" href="css/jquery-ui.css" />
    ...
    <!-- top-header -->
           ...
           <div class="slider-3">
	        <div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> Mr.Travller-Booking</h1>
	</div>
</div>
  <!--- /slider ---->
